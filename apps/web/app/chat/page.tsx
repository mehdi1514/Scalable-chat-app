            ...
            <main>
                    ...
                    <div className="flex-1 overflow-hidden mt-20 mb-20 overflow-y-auto p-4 space-y-4">
                            ...
                            {messages.map((msg, index) => (
                                ...
                                >
                                    <div
                                        className={`min-w-16 md:max-w-md lg:max-w-lg xl:max-w-xl rounded-lg p-3 ${msg.sender?.email === session?.user.email
                                            ? 'bg-blue-500 text-white'
                                            : 'bg-white text-gray-800'
                                            }`}
                                    >
                                        <p className='flex text-[8px] justify-end'>~{msg.sender?.email === session?.user.email ? "You" : msg.sender?.name}</p>
